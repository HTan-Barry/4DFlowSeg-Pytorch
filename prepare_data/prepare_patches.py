...
if __name__ == "__main__": 
    ...
    n_patch = 1    # number of patch per time frame
    ...
    base_path = '../Data'
    lr_file = 'aorta03trans_LR.h5' #LowRes velocity data
    hr_file = 'aorta03trans_HR.h5' #HiRes velocity data
    output_filename = f'{base_path}/val{patch_size}.csv'
